...
class GetItemsView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response({'error': 'Algo salió mal cargando los items del carrito.'},
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if CartItem.objects.filter(cart=cart, product=product).exists():
                return Response(
                    {'error': 'El producto ya está agregado al carrito.'},
            ...
            return Response(
                {'error': 'Algo salió mal agregando un producto al carrito. Intente de nuevo.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GetTotalView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal calculando el costo total. Intente de nuevo'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GetItemTotalView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal calculando el total de productos. Intente de nuevo.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class UpdateItemView(APIView):
    ...
    def put(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'El valor del conteo debe ser un entero.'},
                status=status.HTTP_404_NOT_FOUND)
        ...
        try:
            ...
            if count <= quantity:
                ...
                return Response({'error': 'No hay suficientes productos en stock.'}, status=status.HTTP_200_OK)
            
        except:
            return Response({'error': 'Algo salío mal intentando actualizar el carrito. Intente de nuevo.'}, 
                            status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class RemoveItemView(APIView):
    ...
    def delete(self, request, format=None):
        ...
        try:
            ...
            if not CartItem.objects.filter(cart=cart, product=product).exists():
                return Response({'error': 'El producto no se encuentra en su carrito.'},
                                status=status.HTTP_404_NOT_FOUND)
            ...
            return Response({'error': 'Algo salió mal intentando eliminar el producto del carrito. Intenta de nuevo.'},
                            status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class EmptyCartView(APIView):
    ...
    def delete(self, request, format=None):
        ...
        try:
            ...
            return Response({'success': 'Carrito vaciado con éxito.'},
                            status=status.HTTP_200_OK)

        except:
            return Response({
                'error': 'Algo salió mal intentando vaciar el carrito. Intente de nuevo.'
            }, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class SynchCartView(APIView):
    ...
    def put(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal sincronizando el carrito.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)