...
class GetItemsView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal creando la lista de deseos.'},
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if WishlistItem.objects.filter(wishlist=wishlist, product=product).exists():
                return Response(
                    {'error': 'Este producto ya se encuentra en su lista de deseos.'},
            ...
            return Response(
                {'error': 'Algo salió mal agregando items a la lista de deseos.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GetItemTotalView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try: 
            ...
            return Response(
                {'error': 'Algo salió mal calculando el total de items de la lista de deseos.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    def delete(self, request, format=None):
        ...
        try:
            ...
            if not WishlistItem.objects.filter(wishlist=wishlist, product=product).exists():
                return Response(
                    {'error': 'Este producto no se encuentra en su lista de deseos.'},
                    status=status.HTTP_404_NOT_FOUND)
            ...
            return Response(
                {'error': 'Algo salió mal eliminando los items de la lista de deseos.'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)